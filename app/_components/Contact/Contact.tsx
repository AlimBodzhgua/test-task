...
export function Contact() {
	return (
		<section
			id='contact'
			className='relative flex h-full lg:h-full xl:h-screen flex-col items-center
		...
		>
			...
			<div className='flex flex-col items-center justify-center gap-3 pt-8'>
				...
				<BlurFade duration={0.9} direction='up' inView>
					<h2 className='text-2xl md:text-4xl font-light text-gray-400'>
			...
			<BlurFade duration={0.7} direction='down' inView>
				...
				>
					<CardBody
						className='relative h-auto w-auto rounded-xl border border-black/10
							p-4'
					>
						<CardItem
							as='h2'
							translateZ='50'
							className='mb-4 md:mb-6 text-2xl font-bold text-white'
						>
							Contact information
						</CardItem>

						<div className='flex flex-row flex-wrap gap-6 md:gap-30'>
							<CardItem
								as='div'
								translateX='-15'
								translateZ='40'
								...
								>
									<div
										className='rounded-2xl border-2 border-gray-600
											bg-[#141820] p-4 text-gray-500
											group-hover/link:border-blue-900
											group-hover/link:bg-blue-500/35
						...
						<div
							className='mt-6 md:mt-15 flex flex-col items-start justify-between'
						>
							<CardItem
								as='h2'
								translateZ='50'
							...
							<CardItem translateX='-10' translateZ='35'>
								<Button
									asChild
									size='lg'
									className='rounded-xl border-2 border-gray-600 bg-[#141820]
