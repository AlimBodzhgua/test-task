...
function CarouselNavigation({
	...
	return (
		<div
			className={cn(
				`pointer-events-none absolute left-[-12.5%] top-1/2 flex w-[125%]
		...
		>
			<button
				...
				className={cn(
					`pointer-events-auto h-fit w-fit rounded-full bg-zinc-100 p-2
					transition-all duration-300 dark:bg-zinc-950 hover:scale-125 cursor-pointer`,
			...
			>
				<ChevronLeft className='stroke-zinc-600 dark:stroke-zinc-50' size={23} />
			</button>
			<button
				type='button'
				className={cn(
			...
			>
				<ChevronRight className='stroke-zinc-600 dark:stroke-zinc-50' size={23} />
			</button>
		</div>
	);
}
